				...
				<div className='relative p-5 w-full max-w-2xl max-h-full'>
					<div className='p-2 bg-foreground dark:bg-background rounded-lg border shadow-sm w-full'>
						<div className='px-6 py-4'>
							<h4 className='text-3xl font-semibold leading-none tracking-tight text-primary-foreground dark:text-white '>
								Adblock Detected
							</h4>
						</div>
						...
						<button
							className='inline-flex items-center justify-center rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 h-10 p-6 text-primary-foreground bg-primary m-4'
